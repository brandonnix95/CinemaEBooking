     ...
     <body >
        ...
        <div class="container">
            <div class="py-5 text-center">
                ...
                <h2>Add Show</h2>
                 <p class="lead">All times are PM.</p>
                 <p class "lead"> If your newly added show does not appear, there is another show scheduled for same time/date!</p>
            </div>
            <form class="needs-validation" action = "AddShow">
                <div class="row">
  ...
  <%} %>
                ...
                <div class="row">
                    ...
                    <label for="firstName">Show Date</label><br/>
                      <input type="date" class="form-control" name = "date" id="movieName" placeholder="" value='' required>
