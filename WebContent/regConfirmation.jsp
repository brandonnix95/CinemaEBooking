...
<%
	...
	UserSessionHandler.confirm(code);
...
<html lang="en">
    ...
    <body class="bg-light">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Registration Confirmed!</h1>
                <p class="lead text-muted">Thank you for verifying your account via email.</p>
